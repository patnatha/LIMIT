...
public class DownloadAllDemographicInfo {
    public static void main(String[] args) throws SQLException, IOException {	
        ...
        try {
			...
			try{
				...
				String outputFile = findDirPath() + "/DemographicResults.txt";
    ...
    public static String findDirPath(){
        ...
        theDir = new File("Z:\\downloads\\DemographicResults");
        if(!theDir.exists()){
            theDir.mkdir();
        }
