...
public class DownloadAllDiagnosis {
    public static void main(String[] args) throws SQLException, IOException {	
        ...
        try {
            ...
            String sql = "SELECT ";
			sql += " * ";
			sql += "FROM DiagnosesComprehensive ";
			...
			//sql += "WHERE ActivityDate > '2014/01/01' AND ActivityDate < '2016/01/01'";
			sql += "WHERE ActivityDate > '2016/01/01' AND ActivityDate < '2018/01/01'";
			...
			try{
				...
				String outputFile = findDirPath() + "/DiagnosisResults.txt";
    ...
    public static String findDirPath(){
        ...
        theDir = new File("Z:\\downloads\\Diagnosis");
        if(!theDir.exists()){
            theDir.mkdir();
        }
