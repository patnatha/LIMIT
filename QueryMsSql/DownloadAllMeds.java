...
public class DownloadAllMeds {
    public static void main(String[] args) throws SQLException, IOException {	
        ...
        try {
            ...
            String sql = "SELECT ";
			sql += " * ";
			sql += "FROM MedicationAdministrationsComprehensive ";
			//sql += "WHERE ActivityDate < '2005/01/01'";
			//sql += "WHERE ActivityDate >= '2005/01/01' AND ActivityDate < '2008/01/01'";
			//sql += "WHERE ActivityDate >= '2008/01/01' AND ActivityDate < '2011/01/01'";
			//sql += "WHERE ActivityDate >= '2011/01/01' AND ActivityDate < '2014/01/01'";
			//sql += "WHERE ActivityDate >= '2014/01/01' AND ActivityDate < '2015/01/01'";
			//sql += "WHERE ActivityDate >= '2015/01/01' AND ActivityDate < '2017/01/01'";
			sql += "WHERE ActivityDate >= '2017/01/01' AND ActivityDate < '2018/01/01'";
			...
			try{
				...
				String outputFile = findDirPath() + "/MedResults.txt";
    ...
    public static String findDirPath(){
        ...
        theDir = new File("Z:\\downloads\\MedResults");
        if(!theDir.exists()){
            theDir.mkdir();
        }
