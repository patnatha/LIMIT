...
public class DownloadAllPatientInfo {
    public static void main(String[] args) throws SQLException, IOException {	
        ...
        try {
			...
			try{
				...
				String outputFile = findDirPath() + "/PatientInfoResults.txt";
    ...
    public static String findDirPath(){
        ...
        theDir = new File("Z:\\downloads\\PatientInfoResults");
        if(!theDir.exists()){
            theDir.mkdir();
        }
