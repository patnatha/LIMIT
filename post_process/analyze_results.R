...
print(paste("Lab Values Parametric Quartiles: ", paste(round(((100 - (refConf)/2.0))*100), digits=1), "% <=CI=> ", round(refConf*100, digits=1),"%: (", lowerRefLowLimit, "-", lowerRefUpperLimit, ") <=> (", upperRefLowLimit, "-", upperRefUpperLimit, ")", sep="")), sep="")
